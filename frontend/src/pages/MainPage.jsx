...
const MainPage = () => {
  ...
  const upcomingEvents = filteredEvents.filter(event => new Date(event.startOfEvent) > currentDate);
  const otherEvents = filteredEvents.filter(event => new Date(event.startOfEvent) <= currentDate);
